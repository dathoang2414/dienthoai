...
if(isset($_POST['login']))
{
    ...
    $sql_check = $conn->query("select * from nguoidung where username = '$username'");
    ...
    {
        $sql_check2 = $conn->query("select * from nguoidung where username = '$username' and password = '$password'");
