<div id="tintuc">
	...
	<?php
		...
		// include ('include/mysqli_result.php');

		//$select = $conn->query("select * from tintuc order by matt DESC");
	...
	/*------------Phan trang------------- */
		...
		$sql = $conn->query("SELECT * FROM tintuc ORDER by matt DESC  LIMIT $from, $max_results"); 
...
<div id="phantrang_sp">
	...
	<?php
			...
			$total_results = mysqli_result($conn->query("SELECT COUNT(*) as Num FROM tintuc"),0);  
