...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = $conn->query("SELECT * FROM sanpham inner join danhmuc on sanpham.madm=danhmuc.madm ORDER by idsp DESC  LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			$total_results = mysqli_result($conn->query("SELECT COUNT(*) as Num FROM sanpham"),0);  
